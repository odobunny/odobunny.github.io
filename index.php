...
<html lang="en-US">
<head>
<title>Odobunny-WebSite</title>
<meta charset="utf-8">
<meta name="description" content="Сайт создан для публикации новостей о OdoBunny.">
...
<meta name="author" content="OdoBunny WebSeite by EskaG">
<meta name="copyright" content="OdoBunny by EskaG">
				...
				<div class='landing-con-left content-expand '>
					<div class="landing-con-container scale-content-txt-1 fade-in-onload">
						...
						<div class='landing-tx2-heading'>
							<p>
								 Сайт создан для публикации новостей о OdoBunny.
							</p>
							<div class='landing-btn-container'>
								<a href="https://www.youtube.com/channel/UCnbUz984kTf340uj2gxHSvA">
					...
					<div class="github-con-mantra">
						<div class="github-wrp-mantra scale-content-txt-1 ">
							...
							<div class="github-tx2-mantra darkmode-txt">
								<p>
									 Новости на сайт вылаживает сам EskaG, появились проблемы или же ошибки на сайте? Сайт новый и EskaG его обновляет. Исходный код сайта будет открыт(скоро).
								</p>
							</div>
							<a href="https://github.com/Tirimil" target="_blank">
					...
					<div class="discord-con-mantra">
						<div class="discord-wrp-mantra scale-content-txt-1">
							<div class="discord-tx1-mantra darkmode-txt">
								<h2>Комьюнити OdoBunny</h2>
							</div>
							<div class="discord-tx2-mantra darkmode-txt">
								<p>
									 У OdoBunny есть свой Discord сервер. Уютный сервер с отзывчевой модерацией. Есть вопросы по сайту либо же личный вопрос заходи туда!  
								</p>
							</div>
							<a href="https://discord.gg/tK6KPUVyyY" target="_blank">
